...
class _InstructorScheduleScreenState extends State<InstructorScheduleScreen> {
  ...
  Future<void> _loadSchedule() async {
    ...
    try {
      ...
      final meInstructor = await ApiService.getInstructorMeOrNull();

      if (meInstructor != null) {
        final fetchedSlots = await ApiService.getInstructorSchedule(
            meInstructor['id'].toString());
        ...
        builder: (context, child) {
          return Theme(
            data: AppTheme.darkTheme.copyWith(
              // Corrected from DesignSystem.darkTheme
