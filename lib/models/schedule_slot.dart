class ScheduleSlot {
  ...
  factory ScheduleSlot.fromJson(Map<String, dynamic> json) {
    ...
    return ScheduleSlot(
      ...
      startTime: '${startDateTime.toLocal().hour.toString().padLeft(2, '0')}:${startDateTime.toLocal().minute.toString().padLeft(2, '0')}:00',
      endTime: '${endDateTime.toLocal().hour.toString().padLeft(2, '0')}:${endDateTime.toLocal().minute.toString().padLeft(2, '0')}:00',
      isAvailable: json['isBooked'] != true,
      studentId: json['studentId'] != null ? int.tryParse(json['studentId'].toString()) : null,
      createdAt: DateTime.parse(json['createdAt'].toString()),
      updatedAt: DateTime.parse(json['updatedAt'].toString()),
      instructor: json['instructor'] is Map<String, dynamic> ? json['instructor'] as Map<String, dynamic> : null,
