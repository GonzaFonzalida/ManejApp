...
const instructor_services_1 = __importDefault(require("../instructors/instructor.services"));
const instructor_controller_1 = __importDefault(require("../instructors/instructor.controller"));
...
const PrismaPermissionsRepository_1 = require("../permissions/repositories/PrismaPermissionsRepository");
const PrismaDrivingClassRepository_1 = require("../drivingClass/repositories/PrismaDrivingClassRepository");
const services_1 = require("../drivingClass/services");
const controller_1 = require("../drivingClass/controller");
