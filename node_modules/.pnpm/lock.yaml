...
packages:
  ...
  dependencies@0.0.1:
    resolution: {integrity: sha512-geDgiSknEUQ3IV0hr8EnkrZRdgdybxMzySyWRE8P/TE4teCV7g1rRrHAjd6TdlOLIkZVQm+tZU9AxdLv/m57kg==}
  ...
  node-walker@0.1.0:
    resolution: {integrity: sha512-oC1skUd/BuOroGKhTnUJn1B20ETn9SFaHjRRfS911XcdQxTlzDEWTaK0KJpgluI66tHvFBC3QnN5x7YlZb5SeQ==}
    engines: {node: '>=0.6.0'}
...
snapshots:
  ...
  ts-node-dev@2.0.0(@types/node@24.2.1)(typescript@5.9.2):
    dependencies:
      chokidar: 3.6.0
      dynamic-dedupe: 0.3.0
      minimist: 1.2.8
